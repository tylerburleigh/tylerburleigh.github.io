---
title: 'Joining messy dataframes using fuzzy joins and string cleaning'
date: 2023-08-31
description: 'Tidy Tuesday this week presented a challenge: "There are two datasets this week for which the rows align, but the values might not precisely line up for a clean join." In this post I walk through how I approached solving this using fuzzy joins and targeted string cleaning.'
...
# Approach 2: Fuzzy matching + string cleaning
...
# Final solution: Fuzzy matching + string cleaning + bind_cols
...
final_join %>% 
  ...
  tab_options(ihtml.page_size_default = 3)
```
...
```{r}
data.frame("method" = c("fuzzy join", "fuzzy join + \nstring cleaning", 
                                "fuzzy join + \nstring cleaning + \nbind cols"),
