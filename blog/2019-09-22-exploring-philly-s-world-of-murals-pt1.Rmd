---
title: Exploring Philadelphia's world of murals in data (pt1)
author: ~
date: '2019-09-22'
...
The Mural Arts Philadephia website is not a complete database of Philly murals. As I learned from the data, only about 200 murals have been catalogued on the website, but Philadelphia has <a href="https://www.npr.org/templates/story/story.php?storyId=129281658">over 3000 murals</a>. According to the <a href="https://en.wikipedia.org/wiki/Mural_Arts_Program">Wikipedia page for Mural Arts</a>, more than 600 murals were painted between 2001-2004, but I don't see that in the data. When I look at the data, I see more murals in recent years than in previous years, so there's something of a recency bias.
